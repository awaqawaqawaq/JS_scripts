...
if (window.location.href == "https://humanbenchmark.com/tests/chimp") {
  function mainChimpLoop() {
    ...
    function loopTilEnd() {
      if (
        document.getElementsByClassName("css-de05nr e19owgy710").length == 1
      ) {
        if (
          document.getElementsByClassName("css-de05nr e19owgy710")[0]
        ...
        if (
          document.querySelectorAll('[data-cellnumber="' + i + '"]').length == 1
        ) {
...
if (window.location.href == "https://humanbenchmark.com/tests/aim") {
  ...
  function addStartBtn() {
    ...
    stopbtn.onclick = () => {
      ...
      setTimeout(() => {
        document
          .getElementsByClassName("secondary css-qm6rs9 e19owgy710")[0]
          .click();
      }, 4);
      stopbtn.remove();
    };
...
if (window.location.href == "https://humanbenchmark.com/tests/number-memory") {
  ...
  function waitForNumber() {
    if (document.getElementsByClassName("big-number").length != 0) {
      ...
      for (
        let i = 0;
        i < document.getElementsByClassName("big-number ")[0].innerText.length;
        i++
      ) {
        number.push(
          document.getElementsByClassName("big-number ")[0].innerText[i]
        );
        console.log(
          document.getElementsByClassName("big-number ")[0].innerText[i]
        );
      ...
      if (stopped == false) {
        number.forEach((element, index) => {
          document.getElementsByTagName("input")[0].value =
            document.getElementsByTagName("input")[0].value + number[index];
        });
        document.getElementsByTagName("input")[0].value =
...
if (window.location.href == "https://humanbenchmark.com/tests/memory") {
  ...
  function getHighlightedBoxesIds() {
    boxes = new Array();
    if (
      document.getElementsByClassName("active css-lxtdud eut2yre1").length != 0
    ) {
      document
